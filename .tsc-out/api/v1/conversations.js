...
export default async function conversationsHandler(req, res) {
    ...
    if (req.method === 'GET') {
        const list = Array.from(db.conversations.values()).sort((a, b) => new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime());
