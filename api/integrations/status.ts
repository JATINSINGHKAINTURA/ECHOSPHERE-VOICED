...
export default async function statusHandler(req: IncomingMessage, res: ServerResponse) {
  ...
  const integrations = {
    ...
    gemini: {
      ...
      details: process.env.GEMINI_API_KEY ? 'Gemini 3.6 Flash active' : 'Local responsive heuristic mode active',
    },
    jira: {
      name: 'Atlassian Jira',
